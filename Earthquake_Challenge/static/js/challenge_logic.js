...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  let tentonicPlateData ='https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json'
  d3.json(tentonicPlateData).then(function(data) {
    L.geoJson(data,
      {color: "#B03A2E",
      weight: 5
